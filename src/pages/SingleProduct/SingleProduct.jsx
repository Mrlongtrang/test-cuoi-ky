        ...
        <div className="game-info">
          ...
          <div className="game-container">
            <div className="game-sapo">
              <h4>
                The only survival crafting game set in the Fourth Age of
            ...
            <div className="game-description">
              <p>
                The Lord of the Rings: Return to Moria follows the Dwarves as
                they embark on a new adventure to reclaim their legendary home
                of Moria beneath the Misty Mountains. Players will join forces
                to survive, craft, build and explore the iconic, sprawling
                mines. Courageous expeditioners will need to be vigilant as
                mysterious dangers await. Reclaim the Dwarven homeland of Moria
                Summoned to the Misty Mountains by Lord Gimli Lockbearer,
                players take control of a company of Dwarves tasked to reclaim
                the lost spoils from the Dwarven homeland of Moria—known as
                Khazad-dûm or Dwarrowdelf—in the depths below their very feet.
                Their quest will require fortitude, delving deep into the Mines
                of Moria to recover its treasures. Set in a procedurally
                generated Dwarven realm of Moria, no two adventures will be
                alike, and every expedition is traversable either solo or online
                with companions. Players can mine to craft greater gear and
                resources, but beware mining makes noise, and noise created in
                the quiet deep threatens to awaken the dangers below: where
                there’s clatter, there’s combat. Excavate the mysteries of three
                legendary mountains, extract precious metals, scrape to survive,
                and battle unspeakable forces to learn the secret of the Shadow
                that lurks within.
              </p>
            </div>
          </div>
